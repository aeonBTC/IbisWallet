...
> [!WARNING]
> **Bug bounty program suspended due to lack of funds.** Reports are welcome and will be acknowledged, but no monetary rewards will be paid until the program resumes.
