...
- **RBF by Default** - On-chain отправки по умолчанию сигналят replace-by-fee; можно отключить
...
- **Wipe PIN** - Настройка второго PIN, который молча стирает все данные кошелька на устройстве
...
**Примечание:** Программа bug bounty временно приостановлена из-за отсутствия финансирования. Отчеты приветствуются и будут отмечены, но денежные вознаграждения не будут выплачиваться до возобновления программы.
...
Ibis — бета-версия для опытных пользователей биткоина. Резервная копия seed вне устройства — ожидаемая стандартная практика: проблемы, полностью устранимые восстановлением из seed без кражи третьими лицами, принимаются к сведению, но не вознаграждаются.
...
Последний аудит: [15 августа 2026](https://github.com/aeonBTC/IbisWallet/releases/tag/v4.7.0-beta)
